export class MoulikTotho_2{
    ...
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.1.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.2.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.3.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.4.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.5.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.6.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.7.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.8.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.9.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.10.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.11.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.12.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.13.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.14.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.15.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.16.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.17.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.18.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.19.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.20.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.21.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.22.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.23.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.24.noOfRoom']")
    cy.xpath("//input[@name='onePointSix.buildingRoomUsages.25.noOfRoom']")
    
    //Section 1.6.10 Checkbox
    cy.xpath("//input[@name='onePointSix.prayerRooms0.hasPrayerTypeRoom']")
    cy.xpath("//input[@name='onePointSix.prayerRooms1.hasPrayerTypeRoom']")
    cy.xpath("//input[@name='onePointSix.prayerRooms2.hasPrayerTypeRoom']")
    cy.xpath("//input[@name='onePointSix.prayerRooms3.hasPrayerTypeRoom']")
    cy.xpath("//input[@name='onePointSix.prayerRooms4.hasPrayerTypeRoom']")
    cy.xpath("//input[@name='onePointSix.prayerRooms5.hasPrayerTypeRoom']")
